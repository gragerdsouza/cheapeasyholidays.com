...
<head>
	...
	<link rel="stylesheet" href="{{ config('app.url') }}style.css" type="text/css" media="all">
					...
					<aside id="text-5" class="widget_text">
						<div class="textwidget">
							<ul class="footer_menu">
								...
								<li><a href="#">Privacy Policy</a></li>
								<li>|</li>
								<li><a href="../../twitter.com/physcode/index.htm"><i class="fa fa-twitter"></i></a></li>
								<li><a href="../../www.facebook.com/physcode/index.htm"><i class="fa fa-facebook"></i></a></li>
								<li><a href="../../www.instagram.com/physcode/index.htm"><i class="fa fa-instagram"></i></a>
								</li>
							</ul>
						</div>
					</aside>
...
<!--end coppyright-->
<script type='text/javascript' src='{{ asset('js/jquery.minjs') }}'></script>
<script type='text/javascript' src='{{ asset('js/bootstrap.minjs') }}'></script>
<script type='text/javascript' src='{{ asset('js/vendorsjs') }}'></script>
<script type='text/javascript' src='{{ asset('js/jquery.swipebox.minjs') }}'></script>
<script type='text/javascript' src='{{ asset('js/themejs') }}'></script>
<script type='text/javascript' src='{{ asset('js/gmapjs') }}'></script>
</body>
</html>